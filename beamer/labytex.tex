...
\begin{frame}
  ...
  \begin{minipage}{.4\textwidth}    
    ...
    \only<4>{\includegraphics[width=\linewidth]{../diapos/V2bis/page1.png}}
    \setcounter{pngnumber}{1}
    \forloop{onlynumber}{5}{\value{onlynumber} < 65}{
  ...
  \begin{minipage}{.55\textwidth}
    ...
    \only<33,37>{\par Parfois un nouveau chemin améliore l'accès à une même cellule.}
    \only<44->{Un chemin vers la sortie a été trouvé!}
    \onslide<43->{Backtracking pour reconstituer le chemin}
  \end{minipage}
\end{frame}
